...
const Subcontractors = lazy(() => import("@/features/subcontract/pages/Subcontractors").then(m => ({ default: m.default })));
const SubcontractorDetail = lazy(() => import("@/features/subcontract/pages/SubcontractorDetail").then(m => ({ default: m.default })));
...
const Subcontracts = lazy(() => import("@/features/subcontract/pages/Subcontracts").then(m => ({ default: m.default })));
const SubcontractDetail = lazy(() => import("@/features/subcontract/pages/SubcontractDetail").then(m => ({ default: m.default })));
const Report = lazy(() => import("@/pages/Report").then(m => ({ default: m.Report })));
const FilteredSubcontracts = lazy(() => import("@/features/subcontract/pages/FilteredSubcontracts").then(m => ({ default: m.default })));
